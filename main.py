...
if __name__ == '__main__':
    ...
    parser.add_argument('-train', type=int, default=0, help='True = training, False = playing')
    parser.add_argument('-load_checkpoint', type=int, default=1, help='Load a model checkpoint')
